    ...
    <body>
        ...
        <nav id="navigation">
            ...
            <ul class="menu-list categories has-text-white mt-3">
                ...
                <li><a href="/tutoriales" >Tutoriales<i class="fa-solid fa-angle-right is-pulled-right is-vcentered is-size-3 mr-6"></i></a></li>
                <li><a href="/noticias/">Noticias<i class="fa-solid fa-angle-right is-pulled-right is-vcentered is-size-3 mr-6"></i></a></li>
            </ul>
        </nav>
