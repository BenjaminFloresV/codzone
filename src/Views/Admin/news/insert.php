    ...
    <div class="container is-0-widescreen rounded-corners dark-corners p-5">
        ...
        <form  class="" runat="server" method="post" action="/admin/insertar/noticia" enctype="multipart/form-data" >
            ...
            <div class="columns">
                <div class="column">
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="input" type="text"  placeholder="Título de la noticia" name="title">
                        </div>
                    </div>
                </div>
                <div class="column">
            ...
            <div class="field">
                ...
                <div class="control">
                    <textarea class="textarea height-270px" name="description" placeholder="Descripcion de la clase" >DESCRIPCION DE INICIO_ DESCRIPCION MEDIA_ DESCRIPCION FINAL</textarea>
                </div>
            </div>
