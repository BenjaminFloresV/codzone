                        ...
                        <label class="file-label">
                            ...
                            <div class="column">
                                <figure class="image is-128x128 is-right">
                                    <img id="blah" src="/uploads/images/news/<?=$allData['categoryName']?>/<?=$allData['image_title']?>?<?=time()?>" alt="Imagen" />
                                </figure>
                            </div>
                        </label>
                    </div>
                ...
                <div class="columns">
                    <div class="file">
                        <label class="file-label">
                            ...
                            <div class="column">
                                <figure class="image is-128x128 is-right">
                                    <img id="descImgTarget" src="/uploads/images/news/<?=$allData['categoryName']?>/<?=$allData['image_desc']?>?<?=time()?>" alt="Imagen" />
                                </figure>
                            </div>
                        </label>
                    </div>
                ...
                <div class="columns">
                    <div class="file">
                        <label class="file-label">
                            ...
                            <div class="column">
                                <figure class="image is-128x128 is-right">
                                    <img id="footerImgTarget" src="/uploads/images/news/<?=$allData['categoryName']?>/<?=$allData['image_footer']?>?<?=time()?>" alt="Imagen" />
                                </figure>
                            </div>
                        </label>
                    </div>
                ...
                <div class="columns">
                    <div class="file">
                        <label class="file-label">
                            ...
                            <div class="column">
                                <figure class="image is-128x128 is-right">
                                    <img id="extraImgTarget" src="/uploads/images/news/<?=$allData['categoryName']?>/<?=$allData['image_extra']?>?<?=time()?>" alt="Imagen" />
                                </figure>
                            </div>
                        </label>
                    </div>
