...
class SearchApi
{
                ...
                if( $searchInput !== null ) {
                    ...
                    try {
                        ...
                        if( $result->rowCount() > 0 ){
                            ...
                            $searchpart = explode(" ", $searchInput);
                            foreach ( $searchpart as $value ) {
    ...
    public function getLoadouts()
    {
        if( $_SERVER['REQUEST_METHOD'] === 'GET' ){
            ...
            $lastId = $_SERVER['HTTP_X_LAST_LOADOUT_ID'];
    ...
    public function getNews()
    {
        ...
        if( $_SERVER['REQUEST_METHOD'] === 'GET' ){
            ...
            $sql .= " INNER JOIN news_category ncat ON ncat.category_id=n.category_id";
            $sql .= " INNER JOIN news_images nimages ON nimages.images_id=n.images_id WHERE n.news_id < {$lastId} ORDER BY n.news_id DESC LIMIT 1";
